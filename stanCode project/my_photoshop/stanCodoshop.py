...
FILEPATH1 = "hoover/156-500.jpg"
FILEPATH2 = "hoover/158-500.jpg"
FILEPATH3 = "hoover/200-500.jpg"
...
def get_average(pixels):
    ...
    rgb = []
    pixel_red_total = pixel_green_total = pixel_blue_total = 0
    for i in range(len(pixels)):
        pixel_red_total += pixels[i].red
        pixel_green_total += pixels[i].green
        pixel_blue_total += pixels[i].blue
    rgb += [pixel_red_total//len(pixels), pixel_green_total//len(pixels), pixel_blue_total//len(pixels)]
    return rgb
...
def get_best_pixel(pixels):
    ...
    smallest_color_distance = float("inf")
    best_pixel = []
    for i in range(len(pixels)):
